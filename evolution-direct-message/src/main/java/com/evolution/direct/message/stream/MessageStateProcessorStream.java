...
public class MessageStateProcessorStream {
    ...
    public KStream<String, MessageStateEvent> processState(@Input(MessageStateProcessor.INPUT_CREATE_MESSAGE) KStream<String, CreateMessageEvent> createMessageEventKStream,
                                                           @Input(MessageStateProcessor.INPUT_UPDATE_TEXT_MESSAGE) KStream<String, UpdateMessageTextEvent> updateTextMessageEventKStream,
                                                           @Input(MessageStateProcessor.INPUT_STATE_USER) KStream<String, UserStateEvent> userStateEventKStream) {

        Serde<CreateMessageEvent> serdeCreate = new JsonSerde<>(CreateMessageEvent.class, objectMapper);
        Serde<UpdateMessageTextEvent> serdeUpdate = new JsonSerde<>(UpdateMessageTextEvent.class, objectMapper);
