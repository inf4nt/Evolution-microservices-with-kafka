...
public abstract class AbstractTopology {
    ...
    protected AbstractTopology(String kafkaBootstrapServer, String applicationId, String groupId, Class<? extends Serde> keySerde, Class<? extends Serde> valueSerde) {
